...
SRC = main.c \
	...
	parsing/handle_heredoc.c parsing/heredoc_utils.c \
  	...
  	execution/src/execution.c execution/src/unset.c execution/src/export.c execution/src/exporthelp.c execution/src/redir.c execution/src/exit.c \
  	execution/src/utils.c execution/utils/utils1.c execution/utils/utils2.c	execution/utils/utils3.c execution/utils/utils4.c execution/src/cdhelper.c execution/src/exporthelp2.c execution/src/execution1.c \
